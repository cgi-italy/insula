# Untitled undefined type in Insula vector dataset Schema

```txt
https://cgi-italy.github.io/insula/schemas/v0.2.6/apps/insula-json-vector-dataset.schema.json#/allOf/0
```
