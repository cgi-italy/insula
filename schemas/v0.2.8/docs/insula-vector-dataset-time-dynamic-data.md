...
```txt
https://cgi-italy.github.io/insula/schemas/v0.2.8/apps/insula-vector-dataset-time-dynamic-data.schema.json
```
...
```json
{"$ref":"https://cgi-italy.github.io/insula/schemas/v0.2.8/apps/insula-vector-dataset-time-dynamic-data.schema.json#/$defs/timeDynamicDataSource"}
```
...
```json
{"$ref":"https://cgi-italy.github.io/insula/schemas/v0.2.8/apps/insula-vector-dataset-time-dynamic-data.schema.json#/$defs/timeDynamicDataSourceForeignKey"}
```
