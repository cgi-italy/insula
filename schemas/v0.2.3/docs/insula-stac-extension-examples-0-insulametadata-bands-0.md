...
```txt
https://cgi-italy.github.io/insula/schemas/v0.2.0/stac/insula-stac-extension.schema.json#/examples/0/insula:metadata/bands/0
```
...
```json
{"colorScale":"turbo","range": {"min": 0,"max": 3200
  },"clamp": true
}
```
