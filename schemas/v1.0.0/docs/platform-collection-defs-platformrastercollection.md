# Untitled undefined type in Insula raster dataset Schema

```txt
https://cgi-italy.github.io/insula/schemas/v1.0.0/apps/insula-json-raster-dataset.schema.json#/allOf/0
```
