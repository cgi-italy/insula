...
```txt
https://cgi-italy.github.io/insula/schemas/v0.2.6/apps/insula-json-dataset.schema.json
```
...
```json
{"$ref":"https://cgi-italy.github.io/insula/schemas/v0.2.6/apps/insula-json-dataset.schema.json#/$defs/common"}
```
