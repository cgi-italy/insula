# Time dimension attribute id Schema

```txt
https://cgi-italy.github.io/insula/schemas/v0.2.6/common/vector-collection.schema.json#/properties/timeDimensionAttribute
```
