...
Insula Experiment provides a set of ready-to-use examples to help you in the learning process. These examples are automatically downloaded upon your first login and can be found in your user workspace under the folder named "getting-started".
...
* **Online Access:** While the downloaded examples are readily available offline, you may also find them online on Github at https://github.com/cgi-italy/notebooks.
