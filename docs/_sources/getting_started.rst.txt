...
Insula Experiment is accessible by clicking the "Code" button in the Other Application menu on the top right corner:

.. image:: images/getting_started_code_menu_1.png
   :alt: Code Lab Menu
   :width: 25%

After entering your credentials and signing in, you will see a manu similar to:

.. image:: images/getting_started_code_menu_2.png
   :alt: Code Lab Menu
   :width: 40%

*The exact set of options depends on the Insula's instance you are using.*

After selecting the preferred option, you will see a message similar to:
